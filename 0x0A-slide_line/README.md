...
The goal of this task is to reproduce the [2048](https://intranet.hbtn.io/rltoken/zbaecdLFfcqthH0X60M62g) game(NSFW !!) mechanics on a single horizontal line.
...
* You are __not allowed__ to allocate memory dynamically (malloc, calloc, …)
```
