...
Note: In order for the main file to compile, you are provided with [this static library](https://intranet.hbtn.io/rltoken/0znvLLPdBYRc-ospXC2uAg). This library won’t be used during correction, its only purpose is for testing.
```
