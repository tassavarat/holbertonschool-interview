...
NOTE: [You can find here](https://intranet.hbtn.io/rltoken/D178e_pCETyri6Y7wkPy2A) the functions used in the example. You don’t need to push them, we will compile your file with our own implementation during the correction.
```
